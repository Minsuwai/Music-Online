          ...
          <div class="row container-fluid mt-2">
            ...
            <?php if (!isset($_GET['edit'])) { ?>
              <div class="vinylview">
                ...
                <div class="row">
                  <?php 
                  $sql = "SELECT * FROM vinyls WHERE v_userid = '$user_id' ";
                      ...
                      <div class="card mt-2">
                        ...
                        <div class="card-bordy text-white" style="text-align: center; background-color: #0A2558;">
                          <ul class="list-group list-group-flush" >
                            <li class="list-group-item" style="height: 45px;">Album: &nbsp;&nbsp;<?php echo $row['v_album'] ?></li>
                            <li class="list-group-item" style="height: 45px;">Artist:&nbsp;&nbsp;<?php echo $row['v_artist'] ?></li>
                            <li class="list-group-item" ><a href="?edit=<?php echo $row['v_id']; ?>" class="btn btn-danger">Update</a></li>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <a href="?del=<?php echo $row['v_id']; ?>" class="btn btn-success"  type="button">Yes</a>
